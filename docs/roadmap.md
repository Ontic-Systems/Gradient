...
Significant architectural decisions land as ADRs under [`docs/adr/`](adr/README.md). Five are accepted: [ADR 0001: Effect-tier foundation](adr/0001-effect-tier-foundation.md) (Epic E2 [#295](https://github.com/Ontic-Systems/Gradient/issues/295)), [ADR 0002: Arenas + capabilities (no lifetime annotations)](adr/0002-arenas-capabilities.md) (Epic E3 [#296](https://github.com/Ontic-Systems/Gradient/issues/296)), [ADR 0004: Cranelift dev / LLVM release backend split](adr/0004-cranelift-llvm-split.md) (Epic E6 [#299](https://github.com/Ontic-Systems/Gradient/issues/299)), [ADR 0005: Stdlib core/alloc/std split with effect gating](adr/0005-stdlib-split.md) (Epic E7 [#300](https://github.com/Ontic-Systems/Gradient/issues/300)), and [ADR 0006: Inference engine + @app/@system modes](adr/0006-inference-modes.md) (Epic E8 [#301](https://github.com/Ontic-Systems/Gradient/issues/301)). Together they anchor Sprint 1 (effects + backend), the capability + arena memory model Sprint 2 consumes, the stdlib partition that follows, and the inference engine that makes the effect + capability surface tractable for agents.
